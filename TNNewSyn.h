...
class TNewSynTypeForm : public TForm
{
...
private:	// User declarations
	TAdvColumnGrid* SourceAdvColumnGrid;
private:
	bool GetNeotomaSynonymType(NTMSYNONYMTYPE& NewSynType);
public:		// User declarations
	__fastcall TNewSynTypeForm(TAdvColumnGrid* SourceAdvColumnGrid, TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TNewSynTypeForm *NewSynTypeForm;
//---------------------------------------------------------------------------
#endif
