object ImportChronTabsheetForm: TImportChronTabsheetForm
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Import Analysis Unit Ages'
  ClientHeight = 247
  ClientWidth = 353
  Color = clBtnFace
  ...
  object cxLabel1: TcxLabel
    ...
    Align = alTop
    AutoSize = False
    Caption = 'Import Ages of Analysis Units From Chronolgies Tabsheet'
