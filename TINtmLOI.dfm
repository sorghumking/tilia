object DownloadLOIForm: TDownloadLOIForm
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  Caption = 'Download LOI Data'
  ClientHeight = 238
  ClientWidth = 246
  Color = clBtnFace
  ...
  object cxLabel1: TcxLabel
    ...
    AutoSize = False
    Caption = 
      'Where to download loss-on-ignition data? LOI sample ages will no' +
      't be downloaded to tabsheet.'
  ...
  object cxRadioGroup1: TcxRadioGroup
    Left = 16
    Top = 80
    Caption = 'Where to download?'
    Properties.Items = <
      item
        Caption = 'LOI Tabsheet'
      end
      item
        Caption = 'Spreadsheet'
      end
      item
        Caption = 'Spreadsheet and LOI Tabsheet'
      end>
    ItemIndex = 0
