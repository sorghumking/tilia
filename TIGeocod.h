...
//---------------------------------------------------------------------------
class TGoogleGeocodesForm : public TForm
{
...
public:		// User declarations
	__fastcall TGoogleGeocodesForm(double latitude, double longitude,
		map<UnicodeString,UnicodeString>& PoliticalUnits, TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TGoogleGeocodesForm *GoogleGeocodesForm;
//---------------------------------------------------------------------------
#endif
