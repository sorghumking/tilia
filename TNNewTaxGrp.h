...
#endif
//---------------------------------------------------------------------------
class TNewTaxaGroupForm : public TForm
{
...
private:	// User declarations
	...
	UnicodeString* TaxaGroupIDPtr;
	UnicodeString* TaxaGroupPtr;
	UnicodeString TaxaGroupID;
	UnicodeString TaxaGroup;
public:		// User declarations
	__fastcall TNewTaxaGroupForm(UnicodeString* taxa_group_id_ptr,
		UnicodeString* taxa_group_ptr, TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TNewTaxaGroupForm *NewTaxaGroupForm;
//---------------------------------------------------------------------------
#endif
