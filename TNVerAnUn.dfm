object VerifyAnalUnitForm: TVerifyAnalUnitForm
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Verify Analysis Unit'
  ClientHeight = 202
  ClientWidth = 298
  Color = clBtnFace
  ...
  object AdvLabel1: TAdvLabel
    ...
    Text = 
      ...
      '}}'#13#10'\viewkind4\uc1\pard\lang1033\b\fs16 Ensure that all Analysis' +
      ' Unit parameters have been entered. If not, click Cancel, and en' +
      'ter the necessary data.\b0\par'#13#10'}'#13#10#0
    WordWrap = True
    Version = '1.0.0.3'
  end
  ...
  object AdvEdit3: TAdvEdit
    ...
    EmptyText = 'Empty'
    EmptyTextStyle = []
    LabelCaption = 'Thickness (#Anal.Thick):'
    LabelPosition = lpLeftCenter
    LabelFont.Charset = DEFAULT_CHARSET
    LabelFont.Color = clWindowText
    LabelFont.Height = -11
